...
public class CertificateUtils {
    ...
    public static String signToBase64(byte[] data, String keyStorePath, String alias, String password)
            throws Exception {
        return Base64.encodeBase64String(sign(data, keyStorePath, alias, password));
    }
    ...
    public static String signFileToBase64(String filePath, String keyStorePath, String alias, String password)
            throws Exception {
        return Base64.encodeBase64String(generateFileSign(filePath, keyStorePath, alias, password));
    }
     ...
     * @throws Exception
     */
    public static boolean validateFileSign(String filePath, String sign, String certificatePath, String alias, String password)
            throws Exception {
        boolean result = false;
        // 获得证书
        X509Certificate x509Certificate = (X509Certificate) getCertificate(certificatePath, alias, password);
        // 获得公钥
        PublicKey publicKey = x509Certificate.getPublicKey();
        // 构建签名
        Signature signature = Signature.getInstance(x509Certificate.getSigAlgName());
    ...
    public static boolean verifyBase64SignWithDecrypt(String base64String, String sign, String certificatePath)
            throws Exception {
        byte[] encryptedData = Base64.decodeBase64(base64String);
    ...
    public static void main(String[] args) throws Exception {
        ...
        String sign = signFileToBase64(filePath, keyStorePath, sAlias, "Rjxx1234");
        //Urd1YpYKSIRDwe2WawoWO9QC1nYxCg2r/aeYJSC3N6dfr3vh96mS9XmbDFX4Qk30UY4LR1qNteHP61ABYmjJMLPGyCI/YvxUs8uQFSw6Rwj/DT/tUHnpchsOI+webqP5Yh4pBMnLiRv60OoY+b2YEzHJoMwloROe5Yqoc4Th148=
        //q4q18z2kXvvjiIOpp5RHc6nOzs/+ZsQpkLvIok1P2YEadx+jnavyyNgp+TOE+XusL7HKdbR5XtQbJHImpf9Pze4vJdlzQ8iEndxROm9vkHd20HzLFfsp5pV3nWSAqsEC6U0Ufblbiy6iITTtfNKiwjpNAVj4uIdqhCL0dz+bCGg=
        System.out.println("签名：" + sign);
        //验证签名
        System.out.println("----------------------------");
        boolean result = validateFileSign(filePath, sign, keyStorePath, sAlias, "Rjxx1234");
