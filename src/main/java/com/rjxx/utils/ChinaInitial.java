...
public class ChinaInitial {
	...
	public static void main(String[] args) {
		...
		String str = "中软（上海）计算机(工程)^有%限公@司";		
		System.out.println("原字母：" + str);

		System.out.println("首字母：" + getPYIndexStr(str, false));
	...
	public static String getPYIndexStr(String strChinese, boolean bUpCase) {
		...
		try {
			...
			strChinese = strChinese.replaceAll("\\(|\\)|\\（|\\）|\\*", "");// 替换中英文括号
